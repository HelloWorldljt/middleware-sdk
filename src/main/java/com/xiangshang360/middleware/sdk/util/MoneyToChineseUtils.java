...
public class MoneyToChineseUtils {
    private final static Logger logger = LoggerFactory.getLogger(MoneyToChineseUtils.class);
    //阿拉伯数字对应大写中文数字
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            String num1 = RandomStringUtils.randomNumeric(i + 1);
            String num2 = RandomStringUtils.randomNumeric(2);
            String num3 = num1 + "." + num2;
            String num = toUppercase(num3);
            System.out.println(num3);
            System.out.println(num);
        }
        System.out.println(toUppercase(BigDecimal.ZERO));
    }
     ...
     * @return
     */
    public static String toUppercase(BigDecimal num) {
        if (CalculateUtil.isEqualThan(num, BigDecimal.ZERO)) {
            return "零圆整";
        }
        return toUppercase(CalculateUtil.format(num, 2));
    }
